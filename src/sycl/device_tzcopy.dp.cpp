...
void tzcopy_kernel(lapack::Uplo uplo, int64_t m, int64_t n,
                   src_scalar_t const *const *Aarray, int64_t lda,
                   dst_scalar_t **Barray, int64_t ldb,
...
/* DPCT_ORIG     tzcopy_kernel<<<batch_count, nthreads, 0, queue.stream()>>>(
          uplo,
          m, n,
          Aarray, lda,
          Barray, ldb)*/
...
template void
tzcopy(lapack::Uplo uplo, int64_t m, int64_t n,
